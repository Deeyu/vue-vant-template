    ...
    <div class="cube-recycle-list-main">
      <div class="cube-recycle-list-items" :style="{ height: heights + 'px' }">
        ...
        <div class="cube-recycle-list-pool">
          <template v-if="item && !item.isTombstone && !item.height">
            <div
      ...
      <div v-if="!infinite && !noMore" class="cube-recycle-list-loading" :style="{ visibility: loading ? 'visible' : 'hidden' }">
        <slot name="spinner">
...
<script>
const COMPONENT_NAME = 'recycle-list'
