<template>
  <div ref="wrapper" class="scroll-wrapper">
      ...
      <slot name="pullup" :pullUpLoad="pullUpLoad" :isPullUpLoad="isPullUpLoad">
        <div v-if="pullUpLoad" class="pullup-wrapper">
          ...
          <div v-else class="after-trigger">
            <div class="loader">
              <!-- <svg-icon class="svg_icon" icon-class="loading2"></svg-icon> -->
              <!-- <loading2></loading2> -->
    ...
    <div v-if="pullDownRefresh" ref="pulldown" class="pulldown">
      <slot
        name="pulldown"
      ...
      >
        <div class="pulldown-wrapper" :style="pullDownStyle">
          <div v-show="beforePullDown" class="before-trigger">
            <bubble :y="bubbleY" class="bubble"></bubble>
            <!-- <loading2></loading2> -->
          </div>
          <div v-show="!beforePullDown" class="after-trigger">
            <div v-show="isPullingDown" class="loading">
              <loading2></loading2>
              出行就用万顺叫车
              <!-- <svg-icon class="svg_icon" icon-class="loading"></svg-icon> -->
            </div>
...
import { getRect, camelize, USE_TRANSITION } from './tool'
